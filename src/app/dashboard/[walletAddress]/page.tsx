...
const CreateCampaignModal = (
    ...
    const handleDeployContract = async () => {
        ...
        try {
            ...
            const contractAddress = await deployPublishedContract({
                ...
                publisher: "0xaB4a3749dd8d9467EE790df2390b1D120bfE507B",
                version: "1.0.0",
            });
    ...
    const handleCampaignLengthrange = (value: number) => {
        if (value < 1) {
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex space-x-4">
                        <input 
                            ...
                            onChange={(e) => handleCampaignLengthrange(parseInt(e.target.value))}
                            className="mb-4 px-4 py-2 bg-slate-300 rounded-md"
                        />
                    </div>
